...
namespace Bornlogic.IdentityServer.Models.Messages
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AcceptTosRequest"/> class.
        /// </summary>
        /// <param name="request">The request.</param>
        /// <param name="subject">The subject.</param>
        public AcceptTosRequest(AuthorizationRequest request, string subject)
        {
        ...
        /// <param name="subject">The subject.</param>
        public AcceptTosRequest(NameValueCollection parameters, string subject)
        {
        ...
        public AcceptTosRequest(string clientId, string nonce, string subject)
        {
            ClientId = clientId;
            Nonce = nonce;
            Subject = subject;
